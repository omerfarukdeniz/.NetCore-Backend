    ...
    public class TranslateEntityConfiguration : IEntityTypeConfiguration<Translate>
    {
        public void Configure(EntityTypeBuilder<Translate> builder)
        {
            ...
            builder.HasData(
                ...
                new Translate { Id = 93, LangId = 1, Code = "FirstName", Value = "Adı" },
                new Translate { Id = 94, LangId = 2, Code = "FirstName", Value = "First Name" },
                new Translate { Id = 93, LangId = 1, Code = "LastName", Value = "Soyadı" },
                new Translate { Id = 94, LangId = 2, Code = "LastName", Value = "Last Name" },
